...
3. Open the platformio.ini file in Visual Studio, remove the call in lib_deps_default to download (https://github.com/gaggimate/esp-arduino-ble-scales) otherwise the new build will create a second bluetooth scale library without any of the myscale changes
